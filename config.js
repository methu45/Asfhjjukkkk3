...
module.exports = {
    ...
    CPT: process.env.CPT === undefined ? 'MADE BY ©Axzi-X' : process.env.CPT,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? '©Axzi-X' : process.env.BOT_NAME,
    ...
    LOGSETTINGS: process.env.LOGSETTINGS === undefined ?'94769370897@s.whatsapp.net' : process.env.LOGSETTINGS,
    BRANCH: 'main',
